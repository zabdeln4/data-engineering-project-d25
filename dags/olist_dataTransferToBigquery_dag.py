...
BUCKET_NAME='olist_temp_bucket_ziad'
...
with DAG(
    ...
    postgres_tables = {
        ...
        "geolocations": "SELECT * FROM geolocations",
    ...
    for table_name, query in postgres_tables.items():
        ...
        load_to_bq = GCSToBigQueryOperator(
            ...
            bucket=BUCKET_NAME,
            source_objects=[f'{table_name}.csv'],
        ...
        create_gcs_bucket >> export_to_gcs >> load_to_bq
    ...
    for table_name, endpoint in api_endpoints.items():
        ...
        create_gcs_bucket >> check_api >> load_api_to_bq

    # Cleanup bucket after processing
    cleanup_gcs_bucket.set_upstream([load_to_bq, load_api_to_bq])
